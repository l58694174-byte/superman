...
def gen_receipt() -> str:
    return f"Superman{random.randint(100000, 999999)}-CHK"
...
def ui_profile(user, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    lines = [
        ...
        "━━━━━━━━━━━━━━━━━━━━",
        f"{E_DEV} 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 ➔ {VERSION}  |  <a href='{DEV_LINK}'>Superman</a> {E_PRO}",
    ]
    return "\n".join(lines)
...
def ui_start_screen(user, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    return (
        f"<b><a href='{CHANNEL_LINK}'>[❆]</a> Welcome to Superman Bot 💎</b>\n"
        f"────────────\n"
        f"<b>User</b>    ➳ {uname}\n"
        ...
        f"────────────\n"
        f"{E_DEV} <b>Dev</b>     ➳ <a href='{DEV_LINK}'>Superman</a> {E_PRO}\n"
...
def build_check_result(card_raw: str, gate_name: str, raw_response: str,
    ...
    return (
        ...
        f'<a href="{DEV_LINK}">Superman</a> '
        f'<tg-emoji emoji-id="{PRO_EMOJI_ID}">⭐</tg-emoji></b>'
    )

# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# KEYBOARDS (Cleaned up - Only Checker, Buy Now, Profile)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def kb_result_raw(is_premium: bool = False) -> RawMarkup:
    ...
    return RawMarkup([
        ...
        [_btn("📢 @superman8585_bot", url=CHANNEL_LINK)],
    ])
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# REFERRAL SYSTEM (Backend kept for /start links, UI removed)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async def _fl_job(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if ids:
        ...
        btn_kb   = InlineKeyboardMarkup([[
            InlineKeyboardButton("⚡ @superman8585_bot", url="https://t.me/superman8585_bot")
        ]])
        try:
            await context.bot.send_message(
                target, text,
