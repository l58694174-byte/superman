...
OWNER_ID  = int(os.environ.get("OWNER_ID", "8839509331"))  # @Superman07777
...
VERSION  = "V0.1"
BOT_NAME = "Superman"
DEV_LINK = "https://t.me/superman8585_bot"

BOT_USERNAME  = "superman8585_bot"  # Removed @ symbol for clean link generation
BOT_LINK      = f"https://t.me/{BOT_USERNAME}"


# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 📢  CHANNEL & GROUP LINKS (Cleared to prevent errors)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CHANNEL_USERNAME = ""
GROUP_USERNAME   = ""

# Redirected to bot itself so buttons don't break
CHANNEL_LINK  = BOT_LINK  
GROUP_LINK    = BOT_LINK
SUPPORT_LINK  = BOT_LINK

_ch_raw    = os.environ.get("CHANNEL_ID", CHANNEL_USERNAME).strip()
CHANNEL_ID = int(_ch_raw) if _ch_raw.lstrip("-").isdigit() else _ch_raw

# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 🔒  FORCE-JOIN CHANNELS & GROUPS (DISABLED)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
FORCE_CHANNELS = []  # Empty list means no force-join required!
...
LOCK_FILE        = "/tmp/superman_bot.lock"
...
#   Trial users  → blue "BUY PREMIUM" + grey bot link
...
def kb_result(is_premium: bool = False) -> RawMarkup:
    ...
    return RawMarkup([
        ...
        [_btn("Bot Link", url=BOT_LINK)],  # Changed from @Batcardchk to your Bot Link
    ])
